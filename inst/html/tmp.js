...
// console.log("dic",transpose(dic));
// console.log("dic", dicToDataframe(dic));
// console.log("data", arrayToObj(data, letter_ids))
console.log(parseHotInput(d));
